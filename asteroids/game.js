class Game {
    ...
    _updatePositions() {
        ...
        this.ship.rockets = this.ship.rockets.filter(
            (rocket) => rocket.age < this.ship.maxRocketAge
        );
    ...
    _updateObjectPos(object, dt) {
        object.x += Utils.dXFromAngleAndHypot(
            object.heading,
            dt * object.velocity
        );
        object.y += Utils.dYFromAngleAndHypot(
            object.heading,
            dt * object.velocity
        );
    ...
    _gameOver(message) {
        this.stop();
        setTimeout(
            this._printEndOfGameMessage.bind(this, message, true),
            this.intervalId + 1
        );
    }
    ...
    _gameWon(message) {
        this.stop();
        setTimeout(
            this._printEndOfGameMessage.bind(this, message, false),
            this.intervalId + 1
        );
    }
